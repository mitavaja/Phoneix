...
const AllUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      console.warn("Express API user registry unreachable. Using simulated user profiles.", error.message);
      // Fallback UI mock profiles if server is not running
      setUsers([
        { 
          _id: "647a3e80f12c9c381a4b901a", 
          name: "Alexander Hamilton", 
          email: "alex@hamilton.gov", 
          role: "Seller", 
          status: "Active", 
          createdAt: "2026-01-12T10:00:00Z",
          wallet: { availableBalance: 1250.50, totalBalance: 5000.00, holdBalance: 0 },
          orders: { total: 12, delivered: 10, pending: 2 }
        },
        { 
          _id: "647a3e80f12c9c381a4b901b", 
          name: "Thomas Jefferson", 
          email: "thomas@jefferson.org", 
          role: "Buyer", 
          status: "Active", 
          createdAt: "2026-02-05T10:00:00Z",
          wallet: { availableBalance: 450.00, totalBalance: 1000.00, holdBalance: 0 },
          orders: { total: 5, delivered: 4, pending: 1 }
        },
      ]);
    } finally {
      setLoading(false);
  ...
  const handleBlockToggle = async (id, name, currentStatus) => {
