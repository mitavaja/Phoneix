        ...
        <div className="md:col-span-2 glass-card p-6 rounded-2xl border border-[#687280]/20 space-y-6 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Adjustment Amount */}
              <div className="space-y-1.5">
                <label className="block text-[#687280] font-semibold">Credit Amount (₹ INR) *</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-2.5 font-bold text-[#FF6A00]/80">₹</span>
                  <input
                    type="number"
                    step="0.01"
                    min="0.01"
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="Discrepancy Correction" className="bg-[#0A1F44]">Discrepancy Dispute Reversal</option>
                </select>
              </div>
            </div>
