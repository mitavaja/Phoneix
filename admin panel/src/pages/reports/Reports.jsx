...
const Reports = () => {
  ...
  const metrics = {
    revenue: [
      { label: "Consolidated Revenue Volume", value: "$942,850.10", delta: "+22.4% vs last qtr", isPositive: true },
      { label: "Average Transaction Slabs", value: "$84.20", delta: "+4.1% vs last month", isPositive: true },
      { label: "Administrative Reserves", value: "$120,400.00", delta: "Active escrow nodes", isPositive: true },
      { label: "Discrepancy Disputes Held", value: "$1,450.00", delta: "Surcharges in custody", isPositive: false },
    ],
    shipments: [
      { label: "Total Booked Orders", value: "84,920 Pkgs", delta: "+15.2% vs last week", isPositive: true },
      { label: "Dispatched & In Transit", value: "1,240 Pkgs", delta: "On-time delivery: 98.4%", isPositive: true },
      { label: "Delivered & Settled", value: "82,540 Pkgs", delta: "Average transit: 2.8 days", isPositive: true },
      { label: "Returned to Origin (RTO)", value: "1,140 Pkgs", delta: "RTO Ratio: 1.34%", isPositive: false },
    ],
    users: [
      { label: "Registered Accounts", value: "1,240 Merchants", delta: "+28 registered today", isPositive: true },
      { label: "Active Trading Stores", value: "982 Stores", delta: "Activity Index: 89.2%", isPositive: true },
      { label: "Verified KYC Profiles", value: "1,154 Compliance", delta: "8 files awaiting scan", isPositive: true },
      { label: "Suspended / Blocked Nodes", value: "12 Accounts", delta: "Urgent violations logged", isPositive: false },
    ]
  };
