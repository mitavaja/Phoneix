              ...
              {loading ? (
                ...
                filteredShipments.map((s) => (
                  <tr key={s._id} className="hover:bg-[#E5E7EB]/30 transition-colors">
                    ...
                    <td className="py-4 text-center font-mono font-semibold text-[#FF6A00]/80">${parseFloat(s.charge).toFixed(2)}</td>
                    <td className="py-4">
                      <select
                        value={s.status}
            ...
            <div className="p-6 space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-4 border-t border-[#687280]/20 pt-3">
                ...
                <div>
                  ...
                  <span className="font-bold text-[#FF6A00] font-mono">${parseFloat(selectedShipment.charge).toFixed(2)}</span>
                </div>
              </div>
