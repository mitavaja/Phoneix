...
const Logo = ({ className = "", showText = true, theme = "light", size = "md" }) => {
  // Themes:
  // - "light": navy text, orange arrow, gray stem (for light backgrounds)
  // - "dark": white text, orange arrow, platinum stem (for dark backgrounds)
  // - "navy": white text, orange arrow, gray stem (for navy/blue backgrounds)
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        {/* Top Loop (Stylized P curve) - Navy Blue / White */}
        <path
        ...
        {/* Middle Arrow (Speed/Forward movement) - Forward Orange */}
        <path
          d="M 18 48 L 82 48"
        ...
        {/* Bottom Stem (Reliability/Precision foundation) - Precision Gray / Platinum */}
        <path
