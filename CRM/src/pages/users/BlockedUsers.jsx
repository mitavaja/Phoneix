...
const BlockedUsers = () => {
  ...
  const fetchBlockedUsers = async () => {
    try {
      ...
      console.error("Express API blocked users list unreachable.", error.message);
      setUsers([]);
    } finally {
      setLoading(false);
    }
    ...
    <div className="space-y-8 select-none">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-[#687280]">Review suspended/blocked user accounts, inspect violation reasons, manage account reinstatement.</p>
        </div>
